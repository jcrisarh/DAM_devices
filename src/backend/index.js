...
const routerDispositivos = require('./routes/devicesRoutes');
const irrigationLogsRoutes = require('./routes/irrigationLogsRoutes');
...
app.use('/api/devices', routerDispositivos)
app.use('/api/irrigation_logs', irrigationLogsRoutes);
